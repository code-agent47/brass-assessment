...
var TransferModal = function (_a) {
    var handleClose = _a.handleClose, showOTPModal = _a.showOTPModal;
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, setBanks(reduxStore.submitReducer.results.data)];
                        case 2:
                            _a.sent();
                            return [2 /*return*/];
                    }
                ...
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        if (updatedStore.alertReducer.type === "alert-success") {
                            cogo_toast_1["default"].success(updatedStore.alertReducer.message, { position: "top-right" });
                        }
                        else {
                            cogo_toast_1["default"].error(updatedStore.alertReducer.message, { position: "top-right" });
                        }
